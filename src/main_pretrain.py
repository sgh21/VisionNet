...
def get_default_args():
    ...
    default_args = parser.parse_args([])  # 获取默认参数
    return default_args
...
def get_args_parser():
    ...
    parser.add_argument('--resume_training', action='store_true',
                        help='resume training from pretrained weights')
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.output_dir and (epoch % 20 == 0 or epoch + 1 == args.epochs):
            misc.save_model(
                ...
                loss_scaler=loss_scaler, epoch=epoch, save_full_state=False)

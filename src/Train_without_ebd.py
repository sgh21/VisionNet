...
class CustomDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # 加载额外信息
        xy1 = self.parse_image_info(img1_name)
        xy2 = self.parse_image_info(img2_name)
        ...
        return img1, img2, xy1, xy2, label1, label2
...
def train_one_epoch(model, train_loader, criterion, optimizer, device, epoch, writer):
    ...
    for batch_idx, (img1, img2, embedding_info1, embedding_info2, label1, label2) in enumerate(pbar):
        ...
        embedding_info1 = embedding_info1.to(device)
        embedding_info2 = embedding_info2.to(device)
        ...
        delta_label[:,:2] = delta_label[:,:2]/(-0.0206)+embedding_info1-embedding_info2

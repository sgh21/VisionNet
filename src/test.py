...
def main():
    ...
    parser.add_argument('--cx', type=float, default=0, help='X方向平移距离')
    parser.add_argument('--cy', type=float, default=0, help='Y方向平移距离')
    parser.add_argument('--tx', type=float, default=0.5, help='X方向平移距离')
    parser.add_argument('--ty', type=float, default=0, help='Y方向平移距离')
